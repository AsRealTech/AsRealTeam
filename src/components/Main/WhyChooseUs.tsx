export function WhyChooseUs(){
    return (
        <> 
            <div className="row WhyChoose-section-wrapper">
                <div className="col-md-12 text-center WhyChoose-section-header">
                    <h2>Why Choose Us</h2>
                </div>
                        ...
                        <div className="row">
                            <div className="col-sm rounded">
                                <section className='d-flex justify-content- align-items-center header-anim'>
                                    <small><i className="fas fa-magic fa-3x mb-3"></i></small>
                                    <h4>Fast Development</h4>
                                </section>
                                 <p>Our team is skilled in rapid animation development, ensuring your project is completed on time without compromising quality.</p>
                                 <span className=""><em>40%</em> faster than average </span>
                            </div>
                            <div className="col-sm rounded">
                                <section className='d-flex justify-content- align-items-center header-anim'>
                                ...
                                <p>We create websites that are fully responsive, providing an optimal viewing experience across all devices.</p>
                                 <span className=""><em>100% </em> device compatibility</span>
                            </div>
                            <div className="col-sm rounded">
                                <section className='d-flex justify-content align-items-center header-anim'> 
                                ...
                                <span className=""><em>24/7 </em> customer support</span>
                            </div>
                        </div>  
                    </div>
                </div>
